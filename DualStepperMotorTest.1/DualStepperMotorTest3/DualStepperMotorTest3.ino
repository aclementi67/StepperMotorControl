...
const MOTOR_PINS stepperNorthPins {6, 7, 8, 9};
const MOTOR_PINS stepperEastPins {2, 3, 4, 5};
...
void loop ()
{
  ...
  static int repeat = 1;
  {
    ...
    int directionEast = calcStepperDirection(nextSteps.EAST, currentSteps.EAST);
